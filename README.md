...
- PageTransitions (based on [next-page-transitions](https://github.com/illinois/next-page-transitions)` but with GSAP and external TransitionControllers based on (my) **Houdini**🧙‍♂️) 🔜 [dev here](/bastienrobert/nextstart/tree/features/page-transitions)
